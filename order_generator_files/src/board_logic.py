...
import sqlite3
import csv
import io # Used to create the file in memory


# --- Move your business logic into a function ---
# This function takes the system numbers and PO label as arguments
# It returns the generated file content as a string or bytes.
def generate_board_order_file(system_numbers_str, DATABASE_PATH):
    ...
    # Your original script's connection and logic goes here
    ...
    # 2. Connect to the database (either the synced SQLite file or cloud SQL DB)
    # conn = pyodbc.connect('Driver={...};SERVER=your_cloud_db.database.windows.net;...') # Example for Azure SQL
    # conn = pyodbc.connect('Driver={SQL Server}; SERVER=SR-BF-W10-LP08\SQLEXPRESS1; Database=ECADMASTER2; Trusted_Connection=yes;')
    with sqlite3.connect(DATABASE_PATH) as conn:
        ...
        #    ... (the main for loop from your script) ...
        #    Instead of printing errors, you might want to log them or return an error message.
        #    Make sure to use csvwriter.writerow(row_data) to write to the in-memory object.
        for sysNum in numList:
            ...
            try:
                ...
                if cust_details['contract'] == None and cust_details['customer'] == None:
                ...
                if cust_details['contract'] == None:
                    cust_details['contract'] = ""
                
                if cust_details['customer'] == None:
                    cust_details['customer'] = ""
                
                row_ref = cust_details['contract'] + " " + cust_details['customer']
            except:
                row_ref=""
            ...
            for Colour in Colour_List:
                ...
                tempQuery = "SELECT COUNT(DISTINCT [DIMA]) FROM DISTINTAT where numero = " + str(sysNum) + " AND N6 LIKE 'E1%' and N6 NOT LIKE '%E%E%' and DIMP<=18 and (select reparto from articoli where cod like codcomp ) ='001'"
                BSumCursor.execute(tempQuery)
                ...
                if Other_Edged_Count > 0:
                    ...
                    for row in rows:
                        ...
                        try:
                            ...
                            print(f"Failed to write row (Other Edged): {e}")
                            print(row_data)
                    
                    print("Finished Processing: " + row_ref)
