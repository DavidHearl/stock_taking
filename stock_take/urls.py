...
urlpatterns = [
    ...
    path('dashboard/stock-report/monthly-history/', dashboard_monthly_stock_history, name='dashboard_monthly_stock_history'),
    ...
    path('dashboard/outstanding-report/xero-check/', dashboard_outstanding_xero_check, name='dashboard_outstanding_xero_check'),
    path('dashboard/outstanding-report/xero-check-single/', dashboard_outstanding_xero_check_single, name='dashboard_outstanding_xero_check_single'),
    path('dashboard/week-report/', dashboard_week_report, name='dashboard_week_report'),
    path('dashboard/week-report/pdf/', dashboard_week_pdf, name='dashboard_week_pdf'),
    path('dashboard/monthly-report/', dashboard_monthly_report, name='dashboard_monthly_report'),
    path('dashboard/monthly-report/pdf/', dashboard_monthly_pdf, name='dashboard_monthly_pdf'),
    path('dashboard/avg-report/', dashboard_avg_report, name='dashboard_avg_report'),
    path('dashboard/avg-report/pdf/', dashboard_avg_pdf, name='dashboard_avg_pdf'),
    ...
    path('api/rau-prediction-compare/', views.rau_prediction_compare, name='rau_prediction_compare'),
    ...
    path('purchase-order/<int:po_id>/remove-xero-sync/', purchase_order_remove_xero_sync, name='purchase_order_remove_xero_sync'),
    path('purchase-order/<int:po_id>/split/', purchase_order_split, name='purchase_order_split'),
    path('purchase-order/<int:po_id>/add-timesheet/', po_add_timesheet, name='po_add_timesheet'),
    path('purchase-order/<int:po_id>/delete-timesheet/<int:timesheet_id>/', po_delete_timesheet, name='po_delete_timesheet'),
    path('purchase-order/<int:po_id>/link-timesheet/<int:timesheet_id>/', po_link_timesheet, name='po_link_timesheet'),
    path('purchase-order/<int:po_id>/unlink-timesheet/<int:timesheet_id>/', po_unlink_timesheet, name='po_unlink_timesheet'),
    ...
    path('sale/<int:pk>/payments/<int:payment_pk>/toggle-ignored/', toggle_payment_ignored, name='toggle_payment_ignored'),
    path('sale/<int:pk>/payments/scrape-anthill/', scrape_anthill_payments, name='scrape_anthill_payments'),
    path('sale/<int:pk>/payments/<int:payment_pk>/split/', split_payment, name='split_payment'),
    ...
    path('shortages/create-raumplus-po/', create_raumplus_po, name='create_raumplus_po'),
    path('shortages/create-stock-po/', create_stock_shortage_po, name='create_stock_shortage_po'),
    ...
    path('order/<int:order_id>/pull-anthill-dates/', views.pull_anthill_dates, name='pull_anthill_dates'),
    ...
    path('order/<int:order_id>/clear-os-doors-ordered/', views.clear_os_doors_ordered, name='clear_os_doors_ordered'),
    ...
    path('product/<int:item_id>/delete/', delete_product, name='delete_product'),
    ...
    path('admin-panel/api/run/', run_script, name='run_script'),
    ...
    path('admin-panel/activity-log/resolve/<int:pk>/', resolve_error_log, name='resolve_error_log'),
    path('admin-panel/activity-log/history/', error_log_history, name='error_log_history'),
    path('admin-panel/design-rules/', admin_design_rules, name='admin_design_rules'),
